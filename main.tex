...
\section{Tables}\label{table}
  ...
  TODO how to avoid specifying the alignments \lstinline|\begin{l c}| and use a default? It is not DRY since it repeats the number of column information, and it is style instead of semantics.
...
\section{Citations and bibliography}\label{secCit}
  ...
  BibTeX just generates the LaTeX built-in format and inserts it at the \lstinline|\bibliography{}| macro.
